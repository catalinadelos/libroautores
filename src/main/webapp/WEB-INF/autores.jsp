...
<%@ page import="java.util.ArrayList"  import="models.Autor" %>
...
<body>
	...
	<div class="container border border-primary-subtle rounded-3 bg-light bg-gradient">
		...
		<h4 class="p-1 text-primary border rounded-3">Agregar Autor</h3>
		<div class="row">
	        <div class="col-6">
	        	<div class="m-3">
					<form action="/LibrosAutores/Autores" method="post">
						<div>
						    ...
						    <input type="text" name="nombre" class="form-control" placeholder="Titulo" required></input>
							<label class="form-label p-1 text-light bg-primary border rounded-3">Apellido</label>
						    <input type="text" name="apellido" class="form-control" placeholder="Titulo" required></input>
	
							<label class="form-label p-1 text-light bg-primary border rounded-3">Notas</label>
						    <textarea rows="3" cols="33" name="notas" class="form-control" placeholder="Descripcion"></textarea>	
						</div>	
			...
			<div class="col-6">
				...
				if (autores!=null){%>
					<dl type="circle">
						<%for (Autor a: autores){%> 
							<dd><%=a.id %> - <%=a.nombre %>  <%=a.apellido %>
								<a class="btn btn-outline-primary" href="/LibrosAutores/DetalleAutor?id=<%=a.id%>">
